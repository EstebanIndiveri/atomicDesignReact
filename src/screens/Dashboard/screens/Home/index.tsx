...
import { useErrorContext } from 'contexto/error';
...
import { withContextProvider, useDispatch, useSelector } from 'contexts/Tech';
import ActionCreators from 'contexts/Tech/actions';
...
const Home = () => {
  ...
  const showError = () => {
    setError({ error: true, message: 'qataries ' });
  };
