...
export default function Home() {
  return (
    <div className="default">
      ...
      >
        <Block title="Atom" button="Learn more">
          <p>
            ...
            plasma is composed of neutral or ionized atoms. Atoms are very
            small; typical sizes are around 100 picometers (a ten-billionth of a
      ...
      <div className="col2">
        <p>
          The idea that matter is made up of discrete units is a very old idea,
          appearing in many ancient cultures such as Greece and India. The word
          &quot;atom&quot; was coined by ancient Greek philosophers. However,
          ...
          what atoms look like and how they behave were incorrect. They also
          could not convince everybody, so atomism was but one of a number of
          competing theories on the nature of matter. It was not until the 19th
      ...
      <div className="col2">
        <p>
          ...
          multiple proportions). For instance, there are two types of tin oxide:
          one is 88.1% tin and 11.9% oxygen and the other is 78.7% tin and 21.3%
